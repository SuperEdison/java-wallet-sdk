...
/**
 * EVM KeyHolder 实现，封装私钥与地址。
 * 默认不在 toString 中暴露密钥，支持可选导出。
 */
public final class EvmKeyHolder implements KeyHolder {
    ...
    public EvmKeyHolder(byte[] privateKey, boolean exportable) {
        ...
        this.address = EvmAddress.fromPublicKey(this.publicKey);
